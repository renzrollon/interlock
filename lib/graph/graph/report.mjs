...
export function writeReport(_root, graph, stats) {
  ...
  lines.push('');
  lines.push('- Which files import a given symbol? (`specflow-graph consumers <symbol>`)');
  lines.push('- What is the shortest path between two modules/files? (`specflow-graph path A B`)');
